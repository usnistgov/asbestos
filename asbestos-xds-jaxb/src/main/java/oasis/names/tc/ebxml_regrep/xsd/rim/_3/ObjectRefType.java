...
/**
 *  Use to reference an Object by its id. Specifies the id attribute
 *         of the object as its id attribute. id attribute in ObjectAttributes is exactly the same
 *         syntax and semantics as id attribute in RegistryObject. 
 * 
