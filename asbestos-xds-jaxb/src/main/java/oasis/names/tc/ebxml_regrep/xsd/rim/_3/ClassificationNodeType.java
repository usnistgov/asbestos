 ...
 *         ebRIM. It extends RegistryObject. ClassificationNode is used to submit a Classification tree
 *         to the Registry. The parent attribute is the id to the parent node. code is an optional code
 *         value for a ClassificationNode often defined by an external taxonomy (e.g. NAICS)
 *       
 * 
