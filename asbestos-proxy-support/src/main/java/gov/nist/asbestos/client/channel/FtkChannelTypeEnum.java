...
public enum FtkChannelTypeEnum {
    ...
    mhd(false,
            ...
            new IgTestCollection(IgNameConstants.MHDV_420, "MHDv410_Internal" /* TODO: update later */, "https://profiles.ihe.net/ITI/MHD/4.2.0", IgBasedFhirValidator.getInstance("/npm-fhir-ig-package/ihe.mhd-4.2.0.fhir.tar.gz"))
            )
    );
