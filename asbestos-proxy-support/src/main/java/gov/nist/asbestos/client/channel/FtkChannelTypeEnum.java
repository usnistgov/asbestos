...
//            new IgTestCollection(IgNameConstants.MHDV_410, "MHDv410_InternalCombined", "https://profiles.ihe.net/ITI/MHD/4.1.0", IgBasedFhirValidator.getInstance("/npm-fhir-ig-package/ihe.mhd-4.1.0.fhir.tar.gz"))
            )
    );
