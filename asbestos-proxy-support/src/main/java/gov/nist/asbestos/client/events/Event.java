...
public class Event implements Comparable<Event> {
    ...
    // Support tasks are generated by the Inspector and are not listed
    // in the client test listings.
    public boolean isSupportEvent() {
        ITask task = getClientTask();
        if (task instanceof Task) {
            Headers headers = task.getRequestHeader();
            Header header = headers.get("x-ftk-support");
            return header != null;
        }
        return false;
    }
