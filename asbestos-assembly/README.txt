...
Unzip the contents to a folder of your choice. This folder will be referred to as "<installation-directory>" hereon. In the examples below, you will have to replace the <installation-directory> token with the directory location of the folder where the zip file was extracted.
...
SET CATALINA_HOME=<installation-directory>
...
ExternalCache
The default location for the FhirToolkit ExternalCache is <installation-directory>/Toolkits/ExternalCache
