...
public class GetTestLogRequest {
    private static Logger log = Logger.getLogger(GetTestLogRequest.class);

    private Request request;

    public static boolean isRequest(Request request) {
        return request.uriParts.size() == 7 && request.uriParts.get(3).equals("testlog");
    }

    public GetTestLogRequest(Request request) {
