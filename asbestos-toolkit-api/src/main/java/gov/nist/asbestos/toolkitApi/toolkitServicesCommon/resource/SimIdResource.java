...
import gov.nist.asbestos.toolkitApi.toolkitServicesCommon.SimId;
import gov.nist.asbestos.toolkitApi.toolkitServicesCommon.ToolkitFactory;
 ...
 */
@XmlRootElement
public class SimIdResource implements SimId {
    String user = null;
    String id = null;
